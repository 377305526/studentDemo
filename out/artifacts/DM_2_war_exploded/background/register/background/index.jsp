			...
			function() {
				...
				$('#Exit_system').on('click', function() {
					layer.confirm('是否确定退出系统？', {
						...
						location.href = "/DM-2/AdminServlet?op=out";
...
<body>
				...
				<ul class="nav ace-nav">
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <span class="time"><em
								id="time"></em></span><span class="user-info"><small>欢迎光临,</small>${adminInfo.name}</span>
							<i class="icon-caret-down"></i>
					</a>
						<ul
							class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
							<li><a href="javascript:void(0" name="Systems.html"
								title="系统设置" class="iframeurl"><i class="icon-cog"></i>网站设置</a>
							</li>
				...
				<div id="menu_style" class="menu_style">
					<ul class="nav nav-list" id="nav_list">
						...
						<li><a href="#" class="dropdown-toggle"><i
								class="icon-user"></i><span class="menu-text"> 住户管理 </span><b
								class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
								<c:if test="${userPermission.usermanage_now eq 1 }">
									<li class="home"><a href="javascript:void(0)"
										name="userlist.html" title="在住人员列表" class="iframeurl"><i
											class="icon-double-angle-right"></i>在住人员列表</a></li>
								</c:if>


								<c:if test="${userPermission.usermanage_left eq 1 }">
									<li class="home"><a href="javascript:void(0)"
										name="userlist_left.html" title="离宿人员列表" class="iframeurl"><i
											class="icon-double-angle-right"></i>离宿人员列表</a></li>
								</c:if>
						...
						<c:if test="${userPermission.buildmanage eq 1 }">
							<li><a href="#" class="dropdown-toggle"><i
									class="icon-laptop"></i><span class="menu-text"> 公寓管理 </span><b
									class="arrow icon-angle-down"></b></a>
								<ul class="submenu">
									<li class="home"><a href="javascript:void(0)"
										name="build.html" title="公寓列表" class="iframeurl"><i
											class="icon-double-angle-right"></i>公寓列表</a></li>

								</ul></li>
						</c:if>


						<c:if test="${userPermission.roommanage eq 1 }">
							<li><a href="#" class="dropdown-toggle"><i
									class="icon-laptop"></i><span class="menu-text"> 宿舍管理 </span><b
									class="arrow icon-angle-down"></b></a>
								<ul class="submenu">
									<li class="home"><a href="javascript:void(0)"
										name="room.jsp" title="宿舍列表" class="iframeurl"><i
											class="icon-double-angle-right"></i>宿舍列表</a></li>

								</ul></li>
						</c:if>
						<li><a href="#" class="dropdown-toggle"><i
								class="icon-comments-alt"></i><span class="menu-text">
									审批管理 </span><b class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
								<c:if test="${userPermission.approvalmanage_wait eq 1 }">
									<li class="home"><a href="javascript:void(0)"
										name="Shops_Audit.html" title="等待审核" class="iframeurl"><i
											class="icon-double-angle-right"></i>等待审核<span
											class="badge badge-danger"></span></a></li>
								</c:if>

								<c:if test="${userPermission.approvalmanage_history eq 1 }">
									<li class="home"><a href="javascript:void(0)"
										name="historicalreview.html" title="历史审核" class="iframeurl"><i
											class="icon-double-angle-right"></i>历史审核<span
											class="badge badge-danger"></span></a></li>
								</c:if>
						...
						<c:if test="${userPermission.announcementmanage eq 1 }">
							<li><a href="#" class="dropdown-toggle"><i
									class="icon-bookmark"></i><span class="menu-text"> 公告管理
								</span><b class="arrow icon-angle-down"></b></a>
								<ul class="submenu">
									<li class="home"><a href="javascript:void(0)"
										name="publishannounce.html" title="发布公告" class="iframeurl"><i
											class="icon-double-angle-right"></i>发布公告</a></li>
									<li class="home"><a href="javascript:void(0)"
										name="announcehistory.html" title="历史公告" class="iframeurl"><i
											class="icon-double-angle-right"></i>历史公告</a></li>
								</ul></li>
						</c:if>


						<c:if test="${userPermission.sysmanage_permission eq 1 }">
							<li><a href="#" class="dropdown-toggle"><i
	...
	<div class="footer_style" id="footerstyle">
		...
		<p class="r_f">
			地址：南京市鼓楼区阅江楼街道公共路64号 更多模板： <a href="http://www.mycodes.net/"
